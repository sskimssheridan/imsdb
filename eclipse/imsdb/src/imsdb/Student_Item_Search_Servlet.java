...
public class Student_Item_Search_Servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if(btnSearch.toUpperCase().trim().equals("SEARCH ITEM") || btnSearch.toUpperCase().trim().equals("ADVANCE ITEM SEARCH"))
		{
	    	...
	    	request.getRequestDispatcher("/jsp/task/studentOperation/StudentItemSearch.jsp").forward(request, response);
		}
