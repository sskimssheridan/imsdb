	...
	<tr>
		...
		<td id = "workingBar" colspan="3">
			<table>
				<tr>
					<td colspan="2">
						<h4>DISPLAYING BARCODE FOR ITEM: <%= session.getAttribute("barcodeString") %></h4>
					</td>
				</tr >
				<tr>
					<td colspan="2">
						<div id="barcodeImage">
							<img src="${pageContext.request.contextPath}/BarcodeDisplay_ItemCreated?itemID=<%= session.getAttribute("barcodeString") %>" alt="no image"/>
						</div>
						<br/>
					</td>
				</tr>
